// ======================================================================
// \title  LEDTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LED_LEDTOPOLOGY_HPP
#define LED_LEDTOPOLOGY_HPP
// Included for access to LED::TopologyState and LED::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <BlinkLed/LED/Top/LEDTopologyDefs.hpp>
 ...
 * LED::TopologyState see: LEDTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type BlinkLed::TopologyState see: BlinkLedTopologyDefs.hpp.
 *
