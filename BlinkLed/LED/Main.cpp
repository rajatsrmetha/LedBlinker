...
#include <BlinkLed/LED/Top/LEDTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    BlinkLed::setupTopology(inputs);
    BlinkLed::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    BlinkLed::teardownTopology(inputs);
